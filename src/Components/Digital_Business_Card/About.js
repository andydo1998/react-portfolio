    ...
    return (
        <div className="about--container">
            ...
            <p className="about--text">
                Hi! My name is Andy. I grew up as an only child and am a first generation student.
                I was lucky enough to be able to get the opportunity to attend a four year university
